-- =========================================================
-- Esquema: public 
-- Tabla: public.diario_documentos
-- Objetivo: Tabla maestra consolidada de documentos de diario contable
-- =========================================================
...
CREATE TABLE public.diario_documentos (
    ...
    concepto TEXT,
    importe_moneda_original NUMERIC(18, 2),
    -- Monto tal cual viene en USD o MXN
    ...
    tc_contable_pasivo NUMERIC(12, 6),
    -- TC a la fecha del registro contable
    importe_pasivo_mxn NUMERIC(18, 2),
    -- Valor de la deuda en MXN al registrarse
    iva_pasivo_mxn NUMERIC(18, 2),
    -- Impuesto en pesos
    total_pasivo_mxn NUMERIC(18, 2),
    -- Total de la deuda
    -- Control
    reviso TEXT,
    comentarios TEXT
